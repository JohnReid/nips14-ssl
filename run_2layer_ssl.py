...
if n_labels == 100:
    learn_yz_x_ss.main(3000, n_labels, dataset='mnist_2layer', n_z=50, n_hidden=(
        300,), seed=seed, alpha=0.1, n_minibatches=100, comment='')
else:
    learn_yz_x_ss.main(3000, n_labels, dataset='mnist_2layer', n_z=50, n_hidden=(
        500,), seed=seed, alpha=0.1, n_minibatches=200, comment='')
